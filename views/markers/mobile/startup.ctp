...
echo $validation->bind(array('Marker', 'User','Profile'));
	...
	<div data-role="content" id="mobile">	
		...
		<?php echo $form->create('Markers', array(
			'enctype' => 'multipart/form-data', 'url' => array(
				'controller'  => 'markers', 'action'  => 'startup')
				)
			);
		?>
		...
		if (!$session->read('Auth.User.id')) {
				echo $form->input('User.email_address',array('p' => 'input text required', 'label' => __('E-Mail',true), 'class'=>'text'));


				echo $form->input('User.nickname',array('p' => 'input text required', 'label' => __('Nickname',true), 'class'=>'text'));


				echo $form->input('User.password' ,array('p' => 'input text required', 'label' => __('Password',true), 'class'=>'text'));

				echo $form->input('User.passwd',array('p' => 'input text required', 'label' => __('Password Repeat',true),  'class'=>'text'));
