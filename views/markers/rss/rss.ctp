...
function transform_rss($markers) {
    return array(
      ...
      'description' => 'Wo: '.$markers['Marker']['street'].', '.$markers['Marker']['zip'].' '.$markers['Marker']['city'].'<br/>Was: '.$markers['Marker']['descr'].'<br/>Was ist passiert: '.$markers['Transaction'][0]['name'],
      'author' => "Mark-a-Spot",
